    ...
    <div class="content-container">
        <div class="row">
          ...
          <div class="col-2 d-flex" style="flex-direction: column;">
              <form action="{{url('/slip-jurnal-atk/'.$kodeUnit)}}" method="POST">
                  @csrf
                    <div class="d-flex">
            ...
            <button class="btn btn-outline-success mt-1" onclick="exportTableToExcel('data', 'Laporan_ATK')"> <i class="fa-solid fa-file-excel"></i> Export Excel</button>
